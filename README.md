...
- Validated across multicohort ICU populations
- Outperforms established severity scores on documentation-dense patient subgroups
...
- Validated across heart failure ICU populations (MIMIC-IV)
- Demonstrates significant improvement over baseline prediction
...
- Period-level validation across temporal cohorts
